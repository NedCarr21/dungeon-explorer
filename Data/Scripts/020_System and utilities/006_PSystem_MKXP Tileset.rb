#-------------------------------------------------------------------------------
# This script allows you to bypass the OpenGL Bitmap Size limitations put on Tilesets.
# May cause lag if the tileset is too big. Try keeping your tileset at a minimum of 16384 px
#-------------------------------------------------------------------------------
