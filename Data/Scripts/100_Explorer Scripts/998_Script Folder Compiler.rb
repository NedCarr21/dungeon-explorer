#-------------------------------------------------------------------------------
# This script allows you to compile the Scripts folder into a scripts.rxdata
# This is mainly for "release" versions of the game. Just uncomment the last line
# to activate it.
#-------------------------------------------------------------------------------
